...
nietzsche = Thinker.create([{name: 'Nietzsche', url: 'http://en.wikipedia.org/wiki/Nietzsche', email: 'Nietzche@gmail.com'}]).first
descartes = Thinker.create([{name: 'Descartes', url: 'http://en.wikipedia.org/wiki/Descartes', email: 'Descartes@gmail.com'}]).first
aristotle = Thinker.create([{name: 'Aristotle', url: 'http://en.wikipedia.org/wiki/Aristotle', email: 'Aristotle@gmail.com'}]).first
plato = Thinker.create([{name: 'Plato', url: 'http://en.wikipedia.org/wiki/Plato', email: 'Plato@gmail.com'}]).first
socrates = Thinker.create([{name: 'Socrates', url: 'http://en.wikipedia.org/wiki/Socrates', email: 'Socrates@gmail.com'}]).first
